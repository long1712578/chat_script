...
function loadIframe() {
    ...
    containerDiv.setAttribute('style', 'display: block !important;z-index: 2000000000!important;right: 10px!important;bottom: 0px!important;left: auto!important;position: fixed!important;');
    document.body.appendChild(containerDiv);
    var ifrm = document.createElement("iframe");
    ifrm.setAttribute("frameborder", "0");
    ifrm.setAttribute("border", "0");
    ifrm.setAttribute("id", "messageId");
    ifrm.setAttribute("style", `outline: none !important;
    ...
    htmlMessage += '</head>';
    htmlMessage += '<body>';
    htmlMessage += `<button class="nut-mo-chatbox" onclick="moForm()"><i class="fa fa-comments"></i></button>
